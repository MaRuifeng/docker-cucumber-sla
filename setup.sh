...
# gem install berkshelf -v '5.6.2' --no-rdoc --no-ri # Berkshelf comes with Chef DK by default
bundle install
EOF

# [Chef helper] Resolve cookbook dependencies using Berkshelf; Resolved dependencies are kept within the docker image to speed up future use
# su cobalt <<'EOF'
# source /home/cobalt/.rvm/scripts/rvm
# echo $(ruby -v)
